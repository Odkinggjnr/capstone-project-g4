      ...
      <main className="site-body">
        ...
        <section className="hero-section">
          <div className="hero-left">
            ...
            <p className="hero-text">Elevate your style with timeless elegance.</p>
          ...
          <div className="hero-right">
            <img
              src="./img/model.3.3.png"
              alt="Hero"
              className="lazy-loading hero-image"
            />
          </div>
        </section>
          ...
          <div className="container">
            <div className="about-us-container">
              <div className="about-us-text">
                <h2>ABOUT US</h2>
                <p>
                  We are a fashion e-commerce website dedicated to providing our
                  customers with the latest trends and styles. Our mission is to make
                  fashion accessible and affordable for everyone. We believe that
                  fashion is a form of self-expression and that everyone deserves to
                  look and feel their best.
                </p>
              </div>
              <div className="about-us-image">
                <img src="./img/model.2.jpg" alt="About us" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="faq-section">
          <div className="section-header">
            ...
            <h4 className="section-subtitle">
              with precise, concise, <br /> yet detailed answers.
            </h4>
          </div>
                ...
                <label htmlFor="faq-1" className="faq-toggle">
                  ...
                  <div className="faq-answer">
                    ...
                    <p className="faq-text">
                      ...
                      shipping takes 3-7 business days, while express shipping takes
                      1-3 business days.
                    </p>
                  </div>
                </label>
